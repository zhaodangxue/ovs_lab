...
# 数据
ports = [0, 10, 50, 100, 200, 500, 1000, 2000, 5000, 10000, 50000]
iperf_same_num = [871.4, 870.8, 872.6, 872.4, 869.8, 869.6, 871, 873, 869.6, 868.2, 872.4]
iperf_diff_num = [596, 598.4, 598.8, 598, 595.6, 598.2, 596.2, 596.4, 596.8, 598.6, 597.4]
iperf_regular = [1366, 1370, 1376, 1370, 1384, 1354, 1372, 1356, 1362, 1368, 1366]
